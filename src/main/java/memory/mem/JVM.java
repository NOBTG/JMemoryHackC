...
import memory.me.xdark.shell.JVMUtil;
import memory.me.xdark.shell.NativeLibrary;
...
public final class JVM {
    ...
    public static final JVM INSTANCE;
    ...
    static {
        ...
        try {
            ...
            Object library = CNSTR_NATIVE_LIBRARY.invoke(JVMUtil.class, , false, false);
